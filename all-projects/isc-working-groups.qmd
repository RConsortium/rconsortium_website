...
Many working groups are open for anyone. Please see the [R Consortium Public Calendar](https://zoom-lfx.platform.linuxfoundation.org/meetings/rcons) for the next WG meeting you might want to attend. 
...
[Health Technology Assessment (HTA)](https://github.com/RConsortium/HTA-wg):  To cultivate a more collaborative and unified approach to Health Technology Assessment (HTA) analytics work that leverages the power of R to enhance transparency, efficiency, and consistency, accelerating the delivery of innovative treatments to patients.
...
[nlmixr2:](https://github.com/nlmixr2/nlmixr2) Nonlinear mixed-effects modeling software package that can compete with commercial pharmacometric tools and is suitable for regulatory submissions.

[S7 Package](https://github.com/RConsortium/S7): Object-Oriented Programming. The S7 package is a new OOP system designed to be a successor to S3 and S4. It has been designed and implemented collaboratively by the R Consortium Object-Oriented Programming Working Group, which includes representatives from R-Core, BioConductor, RStudio/tidyverse, and the wider R community.
...
[R CDI](https://www.r-consortium.org/all-projects/r-community-diversity-and-inclusion): R Community Diversity and Inclusion is a group broadly considering how the R Consortium can best encourage and support diversity and inclusion in the R Community.
