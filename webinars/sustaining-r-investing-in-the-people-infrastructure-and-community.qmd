...
Join the R Consortium for a panel discussion with **Simon Urbanek** (R Core | R Foundation President), **Kurt Hornik** (R Core | R Foundation Vice-President), and **Heather Turner** (R Core | R Foundation Board Member) on what it takes to keep R healthy for the long term: technical foundations, the next generation of contributors, and the institutions that support the project.
...
### Simon Urbanek — R Core | R Foundation President

Simon Urbanek is a member of R Core, President of the R Foundation, and an Associate Professor in Statistics at the University of Auckland. He has been closely involved in work supported by the Sovereign Tech Fund to modernize R’s technical foundations, including maintainability, supply-chain security, and portability.

### Kurt Hornik — R Core | R Foundation Vice-President
...
### Heather Turner — R Core | R Foundation Board Member

Heather Turner is a member of R Core and a member of the R Foundation board. She leads work supported by the Research Software Maintenance Fund to grow pathways into contributing to base R, including contributor infrastructure, mentoring, and community events such as R Dev Days and sprints.
