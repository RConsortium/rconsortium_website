...
date: "11/01/2024"
url: "https://r-consortium.org/posts/reviving-sheffield-r-user-group-and-building-tools-for-thyroid-cancer-prediction/"
unpublished: false
categories: ["pharma", "rugs", "events", "ai", "eu"]
image-alt: "Neil Shephard, co-organizer of the Sheffield R User Group in Sheffield, United Kingdom"
---
...
![](NeilShephard.png){width=30% fig-alt="Neil Shephard, co-organizer of the Sheffield R User Group in Sheffield, United Kingdom"}
...
![](SheffieldRUGs.png){fig-alt="Sheffield R User Group April 2024 Meetup “Profiling and Optimising your R code,” Speaker: Dan Brady, Research Software Engineer, University of Sheffield."}
...
![](SheffieldJanuary2024.png){fig-alt="Sheffield R User Group January 2024 Meetup “Automating Health Economic Evaluation with R,” Speaker: Robert Smith, Dark Peak Analytics."}
