...
date: "08/27/2024"
url: "https://r-consortium.org/posts/r4socialscience-empowering-social-science-research/"
unpublished: false
categories: ["rugs", "events", "asia"]
image-alt: "R4SocialScience: Empowering Social Science Research with R in India"
---
...
![](drGarg.jpg){fig-alt="Dr. Mohit Garg, organizer of the R4SocialScience group in Delhi, India"}
...
![](rSocialScience.jpg){fig-alt="Logo for R4SocialScience group in Delhi, India"}
...
![](teaching.jpg){fig-alt="Receiving flowers - From a one day workshop on Doing Research using R, July 6, 2024, Galgotias University"}
...
![](trainingSession.jpg){fig-alt="Training session participants"}
...
![](community.jpg){fig-alt="Speaker and participants"}
...
![](platform.jpg){fig-alt="Screenshot for utilizing Shiny and text mining packages - platform allows real-time data fetching from Scopus API"}
...
![](wordcloud.jpg){fig-alt="Wordcloud of publication titles by Dr. Surendra Singh Yadav of Management Studies"}
