...
date: "04/16/2025"
url: "https://r-consortium.org/posts/strengthening-r-communities-across-borders-ozan-evkaya-on-organizing-the-edinburgh-r-user-group/"
unpublished: false
categories: ["submissions", "pharma", "rugs", "events", "eu"]
image-alt: "Ozan Evkaya, one of the local organizers of the Edinburgh R User group"
---
...
![](Ozan_Evkaya.png){fig-alt="Ozan Evkaya, one of the local organizers of the Edinburgh R User group"}
...
![](EdinburghRUG_Meetup.png){fig-alt="Presenter from Edinburgh R User Group meeting: “No likelihood? No problem! — Bayesian Statistics in R”"}
