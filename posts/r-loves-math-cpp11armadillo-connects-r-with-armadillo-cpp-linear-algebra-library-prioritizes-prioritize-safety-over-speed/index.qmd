...
date: "08/19/2025"
url: "https://r-consortium.org/posts/r-loves-math-cpp11armadillo-connects-r-with-armadillo-cpp-linear-algebra-library-prioritizes-prioritize-safety-over-speed/"
unpublished: false
categories: ["isc", "announcements", "submissions", "pharma", "infrastructure"]
image-alt: "cpp11armadillo R package logo"
---
...
![](pacha.jpg){width=40% fig-alt="Mauricio “Pachá” Vargas Sepúlveda, a PhD student in Economics at the University of Surrey and the developer behind cpp11armadillo, a package funded through the R Consortium’s ISC grant program"}
...
![](cpp11armadillo_logo.png){fig-alt="cpp11armadillo R package logo"}
