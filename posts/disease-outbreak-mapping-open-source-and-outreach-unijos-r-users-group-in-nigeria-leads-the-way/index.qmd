...
date: "05/09/2025"
url: "https://r-consortium.org/posts/disease-outbreak-mapping-open-source-and-outreach-unijos-r-users-group-in-nigeria-leads-the-way/"
unpublished: false
categories: ["rugs", "events", "africa"]
image-alt: "Unijos R Users Group logo"
---
...
![](IkoMusa.png){width=50% fig-alt="Iko Musa, founder of the Unijos R Users Group at the University of Jos (UNIJOS), Nigeria"}
...
![](UnijosRUGlogo.png){fig-alt="Unijos R Users Group logo"}
...
![](UnijosRUGMeeting.png){fig-alt="Unijos R User Group first meeting selfie"}
...
![](UnijosRUGOnlineMeeting.png){fig-alt="Unijos R User Group First Online Meeting Using Microsoft Teams"}
