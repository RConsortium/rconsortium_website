...
date: "05/19/2025"
url: "https://r-consortium.org/posts/reproducibility-without-containers-bruno-rodrigues-introduces-nix-and-the-rix-r-package/"
unpublished: false
categories: ["events"]
image-alt: "Bruno Rodrigues, developer of the `rix` R package"
---
![](brunoheadshot.jpeg){width=30% fig-alt="Bruno Rodrigues, developer of the `rix` R package"}
...
![](continuum.png){width=70% fig-alt="Graphic - reproducibility in on a continuum"}
...
![](nix.png){width=40% fig-alt="Logo for Nix, cross-platform package manager"}
...
![](rix.jpeg){width=40% fig-alt="Logo for {rix}, an R package that simplifies the creation of reproducible environments using Nix"}
