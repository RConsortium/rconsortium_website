...
image-alt: "Figure 1: The first data point of each toy data set."
date: "01/28/2026"
---
...
![The first data point of each toy data set.](toydata_preview.svg){#fig-toydata fig-alt="Figure 1: The first data point of each toy data set."}
...
![The Betti curves of all three toy data sets in {inphr}.](betti_curves.svg){#fig-betti fig-alt="Figure 2: The Betti curves of all three toy data sets in {inphr}."}
