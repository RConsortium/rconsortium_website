...
description: "Introducing the aggreCAT R package for mathematical aggregation of expert elicitation data—from arithmetic means to Bayesian models—with a walkthrough using repliCATS example data."
date: "03/17/2026"
unpublished: false
categories: ["isc", "packages", "community"]
url: "https://r-consortium.org/posts/introducing-aggrecat-mathematical-aggregation-expert-judgements"
format: 
  html:
    code-copy: hover
    code-link: true
