...
unpublished: false 
url: "https://r-consortium.org/posts/strength-in-numbers/"
...
![](vadeq-main-image.png){fig-alt="Mosaic of images of Virginia Department of Environmental Quality (DEQ) team out in nature measuring water quality and other key components"}
...
![](WQM-lake-survey.png){fig-alt="Example Lake Survey with real time data table thanks to Angie Reed"}
...
![](internal-deq-shiny-app.png){fig-alt="Water monitoring data is available the next morning in an internal DEQ shiny application that acts as a database front end."}
