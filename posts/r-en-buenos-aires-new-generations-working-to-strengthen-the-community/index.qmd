...
image: "renBA-4.jpg"
date: "01/23/2025"
url: "https://r-consortium.org/posts/r-en-buenos-aires-new-generations-working-to-strengthen-the-community/"
unpublished: false
categories: ["rugs", "events", "south america"]
image-alt: "Participants from the R in Buenos Aires User Group October 29, 2024, meetup"
---
...
::: columns
::: {.column width="30%"}
![](andrea-gomez-vargas.jpg){fig-alt="Andrea Gomez Vargas, R in Buenos Aires User Group organizer"}
:::
...
::: {.column width="30%"}
![](renBA.png){fig-alt="Logo for R in Buenos Aires User Group"}
:::
:::
...
![](renBA-2.jpg){fig-alt="Participants from R in Buenos Aires User Group meetup held on December 20th, 2024"}
...
::: {.column width="30%"}
<br> <br> ![](arcenso.png){fig-alt="Logo for arcenso, an R package with census data from Argentina"}
:::
:::
...
![](renBA-5.jpg){fig-alt="Photo of Betsy, Ariana, and Andrea, organizers of the R in Buenos Aires User Group October 29, 2024, meetup, from left to right"}
...
![](renBA-3.png){fig-alt="Presenter and attendees from R in Buenos Aires User Group meetup"}
...
![](renBA-4.jpg){fig-alt="Participants from the R in Buenos Aires User Group October 29, 2024, meetup"}
