...
date: "02/13/2025"
url: "https://r-consortium.org/posts/seville-r-users-group-rs-role-in-optimization-research-and-stroke-prevention/"
unpublished: false
categories: ["rugs", "events", "south america"]
image-alt: "Alberto Torrejon Valenzuela, organizer of the Seville R Users Group"
---
...
![](AlbertoValenzuela.png){width=60% fig-alt="Alberto Torrejon Valenzuela, organizer of the Seville R Users Group"}
...
![](SevilleRUGOrganizers.png){width=60% fig-alt="Selfie with Seville R Users Group"}
...
![](SpanishRConference1.png){width=60% fig-alt="Participants from the Spanish R Conference"}
...
![](SpanishRConference2.png){width=60% fig-alt="Participants from the Spanish R Conference"}
...
![](SpanishRConference3.png){width=60% fig-alt="Participants from the Spanish R Conference"}
...
![](SevilleRUGMeeting.png){width=60% fig-alt="Photo from Seville RUG meeting"}
