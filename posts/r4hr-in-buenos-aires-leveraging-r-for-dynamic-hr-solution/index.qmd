...
author: "R Consortium"
image: "marcela-victoria-soto.webp"
date: "05/30/2024"
url: "https://r-consortium.org/posts/r4hr-in-buenos-aires-leveraging-r-for-dynamic-hr-solution/"
unpublished: false
categories: ["rugs", "events", "south america"]
image-alt: "Marcela Victoria Soto, co-organizer of the R4HR - Club de R para RRHH, Buenos Aires, Argentina"
---
...
![](marcela-victoria-soto.webp){fig-alt="Marcela Victoria Soto, co-organizer of the R4HR - Club de R para RRHH, Buenos Aires, Argentina"}
...
![](r4hr-logo.jpg){fig-alt="Logo for R4HR - Club de R para RRHH, Buenos Aires, Argentina"}
...
![](meetup.png){fig-alt="Graphic for online meetup - Visualización de Datos en RRHH"}
...
![](tax.png){fig-alt="Screenshot from online presentation on Annual Income Tax with R"}
...
![](tax2.png){fig-alt="Second screenshot from online presentation on Annual Income Tax with R"}
