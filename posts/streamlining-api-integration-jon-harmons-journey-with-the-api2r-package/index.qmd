...
date: "10/30/2024"
url: "https://r-consortium.org/posts/streamlining-api-integration-jon-harmons-journey-with-the-api2r-package/"
unpublished: false
categories: ["isc", "announcements", "infrastructure"]
image-alt: "Beekeeper logo - One of three part of the api2r package"
---
...
![](JonHarmon.png){width=50% fig-alt="Jon Harmon, Principal Data Solutions Engineer at Atorus, and head of ISC-funded project, api2r."}
...
![](beekeeperlogo.png){width=50% fig-alt="Beekeeper logo - One of three part of the api2r package"}
