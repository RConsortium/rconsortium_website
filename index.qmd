...
<div class="swiper-slide" style="background-image: url(https://i.postimg.cc/Thv82G7s/RMed26-carousel.png);">
<h2>Don't miss out!</h2>
<h2>Keynotes from Yanina Bellini, David Robinson, and Peter Gruber already announced! Diversity and Need-Based Scholarships available!</h2>
<button class="blueButton"><a href="https://rconsortium.github.io/RMedicine_website/Register.html" style="text-decoration: none;">Register Now!</a></button>
</div>
