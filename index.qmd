...
<div class="swiper-slide" id="survival-slide" style="height: 400px; position: relative;">
  <a href="https://r-consortium.org/webinars/from-paper-to-pixels-digitizing-water-quality-data-collection-with-posit-and-esri-integration.html"
     style="
       display: block;
       width: 100%;
       height: 100%;
       background-image: url('https://i.postimg.cc/ydd5c6PV/virginia-deq-webinar-main-image.png');
       background-size: cover;
       background-position: center;
       text-decoration: none;
       color: inherit;
...
<button class="blueButton"><a href="/webinars/tidy-finance-webinar-series.qmd" style="text-decoration: none;">Webinar Information</a></button>
</div>
