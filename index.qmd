...
.rai-cfp-slide .rai-cfp-deadline { margin-top: 0.35rem; }
...
@media (max-width: 700px) {
  .rai-cfp-slide .rai-cfp-copy { margin-left: 0; padding-top: 5.5rem; }
  .rai-cfp-slide .rai-cfp-kicker,
  .rai-cfp-slide .rai-cfp-deadline { font-size: clamp(1.35rem, 6vw, 2rem); }
  .rai-cfp-slide .mustardButton { font-size: 1.25em; padding: 16px 28px; }
}
...
<div class="swiper-slide rai-cfp-slide" style="background-image: url(images/carousel/rplusai-registration-2026.png);">
<div class="rai-cfp-copy">
<p class="rai-cfp-kicker">November 10-22, 2026</p>
<p class="rai-cfp-deadline">Registration Opens Soon!</p>
<button class="mustardButton"><a href="https://rconsortium.github.io/RplusAI_website/" style="text-decoration: none;">More Details</a></button>
</div>
</div>
