...
.rai-cfp-slide .rai-cfp-copy {
  ...
  align-items: center;
  text-align: center;
  margin-left: calc(min(22vw, 14rem) - 60px);
  margin-top: calc(11rem + 60px);
  padding: 0 1.5rem;
}
.rai-cfp-slide .mustardButton {
  z-index: 2;
  margin-top: 0;
  padding: 20px 40px;
  font-size: 1.6em;
...
@media (max-width: 700px) {
  .rai-cfp-slide .rai-cfp-copy { margin-left: -60px; margin-top: calc(12.5rem + 60px); }
  .rai-cfp-slide .mustardButton { font-size: 1.15em; padding: 14px 26px; }
}
...
.isc-grants-slide .blueButton {
  ...
  font-size: 1.6em;
  white-space: nowrap;
  background-color: rgb(21, 56, 112);
  color: #fff;
  border: none;
  box-shadow: 0 6px 14px rgba(0,0,0,.25);
}
.isc-grants-slide .blueButton a {
  color: inherit;
  text-decoration: none;
}
.isc-grants-slide .blueButton:hover {
  background-color: rgb(15, 42, 86);
  color: #fff;
}

.sustaining-r-webinar-slide {
  position: relative;
  background-size: cover;
  background-position: center center;
}
.sustaining-r-webinar-slide .blueButton {
  z-index: 2;
  position: absolute;
  top: 58%;
  left: 50%;
...
.sustaining-r-webinar-slide .blueButton a {
  color: inherit;
  text-decoration: none;
}
.sustaining-r-webinar-slide .blueButton:hover {
  background-color: rgb(15, 42, 86);
  color: #fff;
}
@media (max-width: 700px) {
...
.birdnet-carousel-slide .birdnet-banner {
  position: absolute;
  left: 0;
  right: 0;
  z-index: 2;
  ...
  font-weight: 700;
  line-height: 1.2;
  background: linear-gradient(90deg, rgb(18, 58, 122) 0%, rgb(36, 92, 176) 45%, rgb(18, 58, 122) 100%);
}
.birdnet-carousel-slide .birdnet-banner-top {
  top: 0;
  height: 13%;
  font-size: clamp(1.35rem, 3.4vw, 2.6rem);
}
.birdnet-carousel-slide .birdnet-banner-bottom {
  bottom: 0;
  height: 13%;
  font-size: clamp(1.05rem, 2.4vw, 1.85rem);
}
.birdnet-carousel-slide .blueButton {
  z-index: 3;
  position: absolute;
  top: 50%;
  left: 50%;
...
.birdnet-carousel-slide .blueButton a {
  color: inherit;
  text-decoration: none;
}
.birdnet-carousel-slide .blueButton:hover {
  background-color: rgb(15, 42, 86);
  color: #fff;
}
@media (max-width: 700px) {
...
<div class="swiper-slide sustaining-r-webinar-slide" style="background-image: url(images/carousel/sustaining-r-panel-webinar.jpg?v=2);">
<button class="blueButton"><a href="webinars/sustaining-r-investing-in-the-people-infrastructure-and-community.qmd" style="text-decoration: none;">Register Now!</a></button>
</div>

<div class="swiper-slide isc-grants-slide" style="background-image: url(images/carousel/isc-grants-cfp-2026.png?v=5);">
<button class="blueButton"><a href="all-projects/callforproposals.qmd" style="text-decoration: none;">Accepting submissions now!</a></button>
</div>

<div class="swiper-slide rai-cfp-slide" style="background-image: url(images/carousel/rplusai-early-bird-2026.png?v=3);">
<div class="rai-cfp-copy">
<button class="mustardButton"><a href="https://rconsortium.github.io/RplusAI_website/" style="text-decoration: none;">Register Now!</a></button>
</div>
</div>

<div class="swiper-slide birdnet-carousel-slide" style="background-image: url(images/carousel/birdnettools-2-0-2026.png);">
<p class="birdnet-banner birdnet-banner-top">birdnetTools 2.0 available now!</p>
<button class="blueButton"><a href="posts/from-birdnet-detections-to-ecological-insight-sunny-tseng-on-birdnettools-2-0/" style="text-decoration: none;">Learn more!</a></button>
<p class="birdnet-banner birdnet-banner-bottom">5 million downloads includes R Consortium-supported technology</p>
</div>
