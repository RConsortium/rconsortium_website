...
As defined in its [charter](/rc-docs/ISC-Charter-08-13-24.pdf) (PDF), the projects of the Infrastructure Steering Committee will focus on support of the user base, support of developers, and general advancement of Open Source R. In particular, a commercial fork of R isn’t compatible with that mission, and won’t be a project of the R Consortium.
...
Yes! You can review the [by-laws for the R Consortium, Inc.](/rc-docs/R-Consortium-Bylaws-7-9-2024.pdf) (PDF)and the [charter for the Infrastructure Steering Committee](/rc-docs/ISC-Charter-08-13-24.pdf) (PDF).
...
Yes, individuals may support the R Consortium by joining as a non-voting associate member. You can also support the R project by [contributing to the R Foundation](/about/join) directly.
