...
<a target="_blank" class="tmm_sociallink" href="https://www.linkedin.com/in/kieran-martin-2b298742/?originalSubdomain=uk" title=""><img decoding="async" alt="" src="./images/linkedin.webp"></a>
</div>
...
<p>Kirill Müller has been working on the boundary between data and computer science for more than 25 years. He runs the DBI project, a top-level project at the R Consortium, and previously has been awarded five other projects. Kirill is a core contributor to several tidyverse packages, including duckplyr, dplyr, and tibble. He holds a Ph.D. in Civil Engineering from ETH Zurich and is a founder and partner at cynkra.</p>
