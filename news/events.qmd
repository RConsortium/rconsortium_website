...
df <- data.frame(
  ...
  dates = c("November 12-13, 2025", "July 23, 2025, 5pm PDT, and July 24, 2025, 9am JST", "Aug 8-10, 2025", "Aug 28, 2025", "Sept 17-19, 2025", "Oct 14-16, 2025"),
  location = c("Virtual","Virtual","Durham, NC - Duke University", "Virtual","Barcelona, Spain", "Brighton, UK"),
  icon = c("Conference", "Webinar", "Conference", "Webinar", "Conference", "Conference"),
  Type = c("Conference", "Webinar", "Conference", "Webinar", "Conference", "Conference"),
