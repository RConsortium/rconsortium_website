...
df <- data.frame(
  Title = c(
    "[R/Medicine Webinar - Rix: reproducible data science environments with Nix](https://zoom.us/webinar/register/WN_uwdQizJkRfC66ggTuisxbA)",
    "[R/Medicine 2025](https://rconsortium.github.io/RMedicine_website/)",
    "[useR!2025](https://user2025.r-project.org/)"
  ),

  dates = c("Mar 13, 2025", "Jun 10-13, 2025", "Aug 8-10, 2025"),
  location = c("Virtual", "Virtual", "Durham, NC - Duke University"),
  icon = c("Webinar", "Conference", "Conference"),
  Type = c("Webinar", "Conference", "Conference"),
...
df <- data.frame(
  ...
  Type = c('Webinar', 'Webinar', 'Conference', 'Webinar', 'Webinar', 'Conference', 'Conference', 'Webinar', 'Conference', 'Webinar', 'Conference', 'Webinar', 'Conference', 'Conference', 'Conference', 'Conference', 'Conference',
    'Conference', 'Conference', 'Webinar', 'Webinar', 'Webinar', 'Webinar', 'Webinar', 'Webinar',
    'Webinar', 'Webinar', 'Webinar'),
  icon = c('Webinar', 'Webinar', 'Conference', 'Webinar', 'Webinar', 'Conference', 'Conference', 'Webinar', 'Conference', 'Webinar', 'Conference', 'Webinar', 'Conference', 'Conference', 'Conference', 'Conference', 'Conference',
    'Conference', 'Conference', 'Webinar', 'Webinar', 'Webinar', 'Webinar', 'Webinar', 'Webinar',
    'Webinar', 'Webinar', 'Webinar'),
