...
df <- data.frame(
  Title = c(
    ...
    '<a href="https://r-consortium.org/posts/r_plus_ai_call_for_proposals/" target="_blank" rel="noreferrer noopener">R+AI</a>'
  ),

  dates = c("Oct 16, 2025", "Oct 14-16, 2025", "Oct 28-29, 2025", "Nov 12-13, 2025"),
  location = c("Virtual", "Brighton, UK", "Washington, D.C", "Virtual"),
  icon = c("Webinar", "Conference", "Conference", "Conference"),
  Type = c("Webinar", "Conference", "Conference", "Conference"),
