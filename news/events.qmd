...
df <- data.frame(
  Title = c(
    "[R Consortium Webinar: Scaling the r-spatial ecosystem for the modern composable data pipeline](https://r-consortium.org/webinars/scaling-the-r-spatial-ecosystem-for-the-modern-composable-data-pipeline.html)",
    "R Consortium Webinar: From Paper to Pixels: Digitizing Water Quality Data Collection with Posit and Esri Integration",
  ...
  dates = c("June 24, 2025, 1pm ET", "June 27, 2025, 1pm ET", "June 30, 2025, 10am ET","Jun 19-20, 2025", "Jun 20-21, 2025", "Jun 23-26, 2025", "July 3, 2025", "Aug 8-10, 2025", "Sept 17-19, 2025", "Oct 14-16, 2025"),
  location = c("Virtual", "Virtual", "Virtual", "Accra, Ghana", "Portland, Oregon, USA", "Cold Spring Harbor Laboratory (CSHL), New York", "Cambridge, UK", "Durham, NC - Duke University", "Barcelona, Spain", "Brighton, UK"),
  icon = c("Webinar", "Webinar", "Webinar", "Conference", "Conference", "Conference", "Conference", "Conference", "Conference", "Conference"),
  Type = c("Webinar", "Webinar", "Webinar", "Conference", "Conference", "Conference", "Conference", "Conference", "Conference", "Conference"),
...
df <- data.frame(
  ...
  Type = c('Conference', 'Conference', 'Conference', 'Webinar', 'Webinar', 'Webinar', 'Conference', 'Webinar', 'Webinar', 'Conference', 'Conference', 'Webinar', 'Conference', 'Webinar', 'Conference', 'Webinar', 'Conference', 'Conference', 'Conference', 'Conference', 'Conference',
    'Conference', 'Conference', 'Webinar', 'Webinar', 'Webinar', 'Webinar', 'Webinar', 'Webinar',
    'Webinar', 'Webinar', 'Webinar'),
  icon = c('Conference', 'Conference', 'Conference', 'Webinar', 'Webinar', 'Webinar', 'Conference', 'Webinar', 'Webinar', 'Conference', 'Conference', 'Webinar', 'Conference', 'Webinar', 'Conference', 'Webinar', 'Conference', 'Conference', 'Conference', 'Conference', 'Conference',
    'Conference', 'Conference', 'Webinar', 'Webinar', 'Webinar', 'Webinar', 'Webinar', 'Webinar',
    'Webinar', 'Webinar', 'Webinar'),
