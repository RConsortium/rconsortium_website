...
df <- data.frame(
  Title = c(
    "[useR!2025](https://www.r-project.org/conferences/)",
    "[R/Medicine 2025](https://rconsortium.github.io/RMedicine_website/)"
  ),

  dates = c("Jun 10-13, 2025", "Aug 8-10, 2025"),
  location = c("Durham, NC - Duke University", "Virtual"),
  icon = c("Conference", "Conference"),
